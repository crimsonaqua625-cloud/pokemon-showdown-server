 ...
 * @type {string}
 */
export const bindaddress = '127.0.0.1';
 ...
 * @type {AnyObject?}
 */
export const wsdeflate = null;

/*
// example:
export const wsdeflate = {
	level: 5,
	memLevel: 8,
	strategy: 0,
 ...
 */
export const ofemain = false;
export const ofesockets = false;
export const debugsimprocesses = true;
export const debugvalidatorprocesses = true;
export const debugdexsearchprocesses = true;
/**
 ...
 * @type {AnyObject?}
 */
export const crashguardemail = null;
/* export const crashguardemail = {
	options: {
 ...
 *   Greek or Cyrillic.
 */
export const disablebasicnamefilter = false;

/**
 * allowrequestingties - enables the use of `/offerdraw` and `/acceptdraw`
 */
export const allowrequestingties = true;
 ...
 */
export const reportjoinsperiod = 0;
 ...
 */
export const reportbattles = true;
 ...
 */
export const reportbattlejoins = true;
 ...
 */
export const nobattlesearch = false;
 ...
 */
export const punishmentautolock = false;
 ...
 */
export const restrictLinks = false;
 ...
 * @type {false | number}
 */
export const forceregisterelo = false;
 ...
 */
export const consoleips = ['127.0.0.1'];
 ...
 * the server.
 */
export const watchconfig = true;

/**
 * logchat - whether to log chat rooms.
 */
export const logchat = false;

/**
 * logchallenges - whether to log challenge battles. Useful for tournament servers.
 */
export const logchallenges = false;

/**
 * loguserstats - how often (in milliseconds) to write user stats to the
 * lobby log. This has no effect if `logchat` is disabled.
 */
export const loguserstats = 1000 * 60 * 10; // 10 minutes

/**
 * inactiveuserthreshold - how long a user must be inactive before being pruned
 * from the `users` array. The default is 1 hour.
 */
export const inactiveuserthreshold = 1000 * 60 * 60;
 ...
 * @type {boolean}
 */
export const autolockdown = true;
 ...
 */
export const noguestsecurity = false;
 ...
 */
export const tourroom = '';
/** @type {string[]} */
export const tourannouncements = [/* roomids */];
export const tourdefaultplayercap = 0;
export const ratedtours = false;
/**
 * appealurl - specify a URL containing information on how users can appeal
 * disciplinary actions on your section. You can also leave this blank, in
 * which case users won't be given any information on how to appeal.
 */
export const appealurl = '';
 ...
 */
export const repl = true;
export const replsocketprefix = './logs/repl/';
export const replsocketmode = 0o600;
 ...
 */
export const disablehotpatchall = false;
...
export const serverPublic = true;
...
if (fs.existsSync(storageFile)) {
    storage = JSON.parse(fs.readFileSync(storageFile));
}
